  ...
  return (
    <main className="page">
      <section className="card">
        ...
        <p className="subtle">
          Flow: submit question, inspect/revise plan, approve, then backend executes in the background.
        </p>
        ...
        <section className="card">
          ...
          <ol className="steps">
            {job.plan.steps.map((step) => {
              ...
              const hasStepOutput = (step.status === "completed" || step.status === "failed") &&
                  ...
                  {hasStepOutput ? (
                    <details className="step-detail">
                      ...
                      {artifact ? (
                        ...
                        <p className="subtle">No structured result payload was recorded for this step.</p>
                      )}
                    </details>
                  ) : null}
                </li>
